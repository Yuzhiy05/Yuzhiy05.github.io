...
```bash
# 单配置生成器指定
cmake .. -DCMAKE_TOOLCHAIN_FILE=D:/workfile/compiler/toolchaincmake/clang-msvc-toolchain.cmake  -G "Ninja" -DCMAKE_BUILD_TYPE=Release

# Release 构建项目
cmake --build . --config Release

# cmake 安装，指定安装地址
cmake --install . --prefix "D:\workfile\lib\abseil"
